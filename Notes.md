# Notes
These notes are for my reference only - not for the AI. 

## General
Entwicklung mit Antigravity auf 8gentli-Elitebook.  
Deployment mit rsync auf Server-Elitebook.  
Status siehe .md-Files.

## TODOs
- [x] Init 0 statt 8.4
- [x] Diagramm-Zoom
- [x] Titel
- [x] Diagramm-Buttons: Refresh, +, -
- [-] Diagramm Anzeige: Tag und vor/zurück -> damit hatte Cursor verdammt Mühe. Ist auch unnötig - verzichten.
